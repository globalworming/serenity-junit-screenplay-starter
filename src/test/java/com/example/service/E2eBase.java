...
public class E2eBase {
  ...
  protected final Cast players =
      Cast.whereEveryoneCan(PlayAGame.through(playService), ManageGames.through(gameService));
  ...
  public void setUp() {
    ...
    admin.remember(Memory.ACCESS_TOKEN, "adminAccessToken");
